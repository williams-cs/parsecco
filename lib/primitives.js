...
(function (Primitives) {
    ...
    class HighWaterMark {
        constructor(location, expecting) {
            this.location = location;
            this.expecting = expecting;
        }
    }
    Primitives.HighWaterMark = HighWaterMark;
    /**
    ...
    function sat(char_class) {
        ...
        let p = (x) => {
            if (pred2(x)) {
                ...
                return zero("next character should be one of [" + char_class.toString() + "]");
            }
        };
        return bind(item())(p);
    }
...
//problem with str parser
var input = new charstream_1.CharUtil.CharStream("helloworld");
console.log(Primitives.str("hello")(input));
// ??common faulty output:
//       -  "expecting": "next character should be one of [0]"
// has to do with sat?
