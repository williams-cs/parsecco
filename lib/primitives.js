...
(function (Primitives) {
                        ...
                        switch (o2.tag) {
                            ...
                            case "failure":
                                ...
                                if (o.error_pos == o2.error_pos) {
                                    ...
                                    console.log(str1 + " varparser");
                                    console.log(str2 + " between");
                                    let o1Edit = o.error.minEdit(str1, o.error.expectedStr());
                                    console.log(o1Edit + " var");
                                    let o2Edit = o2.error.minEdit(str2, o2.error.expectedStr());
                                    console.log(o2Edit + " Between");
                                ...
                                //if (o2Edit == o1Edit) {
                                console.log(o.error_pos + " foo errorpos");
    ...
    function between(popen) {
        return (pclose) => {
            return (p) => {
                let l = left(p)(expect(pclose)((error) => new BetweenRightError_1.BetweenRightError(error)));
                let r = right(expect(popen)((error) => new BetweenLeftError_1.BetweenLeftError(error)))(l);
                return r;
            };
        };
    }
    ...
    function strSat(strs) {
        ...
        return (istream) => {
            ...
            return new Failure(istream, istream.startpos, new StringError_1.StringError(istream.substring(istream.startpos, istream.endpos).input));
        };
    }
